...
public final class JtelistaDetallePedidoGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,0,0,3,3,3,17,17,17,20,20,20,25,25,25,28,28,28,33,33,33,51,51,53,53,53,54,54,54,55,55,55,56,56,56,58,58,65,65,65,70,70,70,71,71,71,77,77,77,81,81,85,85,87,87,87,89,89,93,93};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, edu.unam.integrador.paginas.ModeloDetallesPedidos modelo) {
		...
		if (modelo.rol.equals("admin")) {
			...
			jteOutput.writeContent("    \n        <center>\n            <a href=\"/pedido/listapedido/cliente/");
			jteOutput.setContext("a", "href");
			jteOutput.writeUserContent(modelo.idCliente);
			jteOutput.writeContent("\" type=\"button\" class=\"btn btn-primary justify-content-center align-items-center\"> Volver </a>\n        </center>\n    ");
		}
		jteOutput.writeContent("\n</div>\n\n\n");
